...
class HardwareInterface:
    def __init__(self,link):
        ...
        # Calves: Set to 130/120 to ensure maximum tuck (matching your last successful BR adjustment).
        self.physical_calibration_offsets = np.array(
                    [[15, 95, 95,  3],  # Hips (FL & BR confirmed at 95)
                     [60,  1, 60,  8],  # Thighs (Unchanged)
                     [110, -110, 150,-80]]) # Calves (Using your max tucking values)
        ...
        self.inversion_mask = np.array([
            ...
            [0, 1, 0, 1], # Thighs: FL and BL (Left Side) are inverted
            [0, 1, 0, 1]  # Calves: FL and BL (Left Side) are inverted
        ])
    ...
    def set_actuator_positions(self, joint_angles):
        for leg_index in range(4):
            for axis_index in range(3):
                ...
                elif final_angle > 180: final_angle = 180
